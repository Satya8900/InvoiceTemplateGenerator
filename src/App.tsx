            ...
            <div className="border-2 border-gray-800 p-6">
              ...
              <div className="flex justify-between items-center mb-6 pb-4 border-b border-gray-300">
                <div>
                  ...
                  <span className="inline-block border-b border-dotted border-gray-400 min-w-[80px] h-6"></span>
                </div>
                <div>
                  <span className="text-gray-700">Date: </span>
                  <span className="inline-block border-b border-dotted border-gray-400 min-w-[120px] h-6"></span>
                </div>
              </div>
              ...
              <div className="mb-6">
                ...
                <span className="border-b border-dotted border-gray-400 inline-block min-w-[300px] h-6"></span>
              </div>
              ...
              <div className="flex justify-between items-center py-3 border-t-2 border-gray-800">
                ...
                <span className="inline-block border-b border-gray-400 min-w-[100px] h-7"></span>
              </div>
